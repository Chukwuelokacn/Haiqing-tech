...
const products = [
...

  {
    ...
    extraImages: ["/images/Claid AI (1).webp"],
    video: null,
    description: `
  ...
  {
    id: 4,
    name: "Airfryer 5litre",
    price: "2,450,000",
    oldPrice: "3,050,000",
    discount: "20%",
    image: "/images/Claid AI (3).webp",
    extraImages: ["images/HCT Packs (3a).jpeg", "images/HCT Packs (3b).jpeg"],
    video: "videos/product3.mp4",
    description: `
      <p>The <strong>3.5KVA Hybrid Solar Inverter</strong> offers seamless switching between
  ...
  
  {
    ...
    oldPrice: "7,500",
    discount: "25%",
    image: "/images/Product temp.webp",
    extraImages: ["images/HCT Packs (3a).jpeg", "images/HCT Packs (3b).jpeg"],
    video: "videos/product3.mp4",
    description: `
      <p>The <strong>3.5KVA Hybrid Solar Inverter</strong> offers seamless switching between
