...
//   HAIQING DESIGNED SLIDER ===----------------------------------------------?
	// Function to set background image based on screen size
function setResponsiveImages() {
    document.querySelectorAll('.responsive-image').forEach(function(el) {
        const desktopImage = el.getAttribute('data-desktop');
        const mobileImage = el.getAttribute('data-mobile');
        const imageToUse = window.innerWidth <= 768 ? mobileImage : desktopImage;
...
// Show popup when terms link is clicked
